...
<body>
		<p>Agência não cadastrada:</p>		
		<p>${ agenciaCadastrada } não cadastrada!</p>	
		<p>Erro: ${erro}</p>	
		<br/>
		<br/>
		<br/>
		<button><a href='http://localhost:8080/SistemaBancario/entrada?novaAgencia'>Voltar para cadastro.</a> </button>
