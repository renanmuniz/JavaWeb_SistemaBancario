...
<body>
		<p>Conta Pessoa Física Não Cadastrada:</p>		
	    <p>Conta Pessoa Física CPF ${ contaPessoaFisicaNaoCadastrada } Não foi Cadastrada!</p>
	    <p>ERRO: ${ erro } </p>				
		
		<br/>
		<br/>
		<br/>
		<button><a href='http://localhost:8080/SistemaBancario/entrada?acao=novaContaPF'>Voltar para cadastro.</a> </button>
		...
		<!-- <button><a href='http://localhost:8080/SistemaBancario/formIncluiContaPF.jsp'>Voltar para cadastro.</a> </button>       -->
